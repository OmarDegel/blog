        ...
        <div class="col-md-6">
          <div class="post-entry text-center">
            ...
            <div class="post-meta align-items-center text-center">
              <figure class="author-figure mb-0 me-3 d-inline-block"><img src={{ asset("images/person_1.jpg")}} alt="Image" class="img-fluid"></figure>
          ...
          <div class="post-content-body">
            ...
            <div class="row my-4">
              <div class="col-md-12 mb-4">
                <img src="{{ asset('imgs/'.$post->path_photo) }}" alt="Image placeholder" class="img-fluid rounded">
              </div>
          ...
          <div class="pt-5 comment-wrap">
            ...
            <div class="comment-form-wrap pt-5">
              <h3 class="mb-5">Leave a comment</h3>
                ...
                <div class="form-group">
                  <input 
                  type="submit" value="Post Comment" class="btn btn-primary">
                </div>
          ...
          <div class="sidebar-box">
            <div class="bio text-center">
              ...
              <div class="bio-body">
                ...
                <p><a href="#" class="btn btn-primary btn-sm rounded px-2 py-2">visit her profile</a></p>
                <p class="social">
